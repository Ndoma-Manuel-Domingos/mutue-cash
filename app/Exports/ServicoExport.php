...
class ServicoExport implements FromCollection, 
    WithHeadings, 
    ShouldAutoSize, 
    WithMapping,
    WithEvents,
    ...
    WithCustomStartCell
{
    ...
    */
    public function collection()
    {
        ...
        return TipoServico::with('polo')->where('codigo_ano_lectivo', $this->anoLectivoActivo())->whereNull('codigo_grade_currilular')->whereNotIn('Codigo', $ids)->get();
    }
    ...
    public function drawings()
    {
        ...
        $drawing->setDescription('SERVIÇOS (PREÇARIOS)');
