...
class PagamentosExtratoExport extends DefaultValueBinder implements FromCollection, WithMapping, WithTitle, WithHeadings, WithDrawings, WithStyles, WithCustomStartCell, WithCustomValueBinder, ShouldAutoSize
{
    ...
    */
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('G3', $this->data_inicio ?? date("Y-m-d"));
        $sheet->setCellValue('F4', 'DATA FINAL');
        $sheet->setCellValue('G4', $this->data_final ?? date("Y-m-d"));
