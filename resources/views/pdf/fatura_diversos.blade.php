...
<body>
    <main>
        ...
        <thead>
            ...
            <th style="background-color: #2e306e; color:white; border:solid 1px white; padding: 0px;">Prestação</th>
        ...
        <thead>
            <tr>
                ...
                <th style="text-align:left;padding: 0px;font-size:9px;">
                        ...
                        ESTADO: <b>{{$pagamento->Status=='PAID'?'PAGO':($pagamento->Status=='ACTIVE'?'PENDENTE':'EXPIRADO')}}</b>
                    </th>
                    @else
                    <th style="text-align:left;padding: 0px;font-size:9px; font-weight: bolder">COORDENADAS BANCÁRIAS<br>
                ...
                <table style="font-size: 10px!important;"  >
                    <thead >
                        <tr style="">
                            <th style="background-color: #2e306e; color:white; border:solid 1px white; padding: 0px;" >Nº</th>
                            <!--th class="wd-40p">Valor</th-->
                            <th style="text-align: left!important;background-color: #2e306e; color:white;font-size:10px; border:solid 1px white; padding: 0px;" >Referências&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th style="background-color: #2e306e; color:white; border:solid 1px white; padding: 0px;">Entidade</th>
                            <th style="background-color: #2e306e; color:white; border:solid 1px white; padding: 0px;">Montante</th>
                            <th style="background-color: #2e306e; color:white; border:solid 1px white; padding: 0px;">Parcela</th>

                            <th style="background-color: #2e306e; color:white; border:solid 1px white; padding: 0px;">Data de Expiração</th>
                            <th style="background-color: #2e306e; color:white; border:solid 1px white; padding: 0px;">Estado</th>
                        </tr>
                    </thead >
                    <tbody style="text-align: center!important">
        ...
        <div style="font-size: 10px;">
            <span style="width: 90%; word-break: break-all; float: left;text-justify: distribute-all-lines;"> <div style="font-weight: bolder">Observação:</div>
                ...
                @if ($aluno->negociacao)
                    Deverá ser pago os 50% do valor em dívida <b>{{ number_format($aluno->primeiroValorApagar, 2, ',', '.') }}
