                ...
                <form id="form" @submit.prevent="adicionarMeses">
                  ...
                  <div class="row">
                    ...
                    >
                      ...
                      <tbody>
                        <tr v-for="(item, key) in tabela" :key="item">
                          <td>{{ ++key }}</td>
  ...
  methods: {
    ...
    formatarMoeda() {
      ...
      if (this.valor_por_depositar == this.pagamento.valor_depositado) {
        ...
        if (
          this.pagamento.valor_depositado - this.total_adicionado > 0 ||
          this.valor_depositado_tese - this.total_adicionado > 0
        ) {
          this.condicao_troco = true;
        } else {
        ...
        this.troco = this.formatPrice(
          this.pagamento.valor_depositado - this.fatura.ValorAPagar
        );
        if (
          this.pagamento.valor_depositado - this.fatura.ValorAPagar > 0 ||
          this.valor_depositado_tese - this.fatura.ValorAPagar > 0
        ) {
          this.condicao_troco = true;
        } else {
          this.condicao_troco = false;
