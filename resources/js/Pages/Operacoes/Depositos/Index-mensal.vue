  ...
  <MainLayouts>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0">Depósito de valores efetuados no período de</h1>
          </div>
          <div class="col-sm-4">
            <button
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td>
                          {{
                            item.matricula
                              ? item.matricula.admissao.preinscricao
                                  .Nome_Completo
                              : item.candidato
                        ...
                        <td
                          class="text-center"
                          v-if="user.auth.can['alterar deposito']"
                        >
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      if (
        this.removerFormatacaoAOA(this.form.valor_a_depositar) <
        this.valor_a_depositar_padrao.Valor
      ) {
        Swal.fire({
          title: "Atenção",
