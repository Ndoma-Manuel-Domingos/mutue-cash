    ...
    <body class="hold-transition login-page"
        ...
        <AuthLayouts>
            ...
            <video autoplay muted loop id="myVideo">
              <source src="images/_import_62a2d75acbd437.11177372_1080p_12000br.mp4" type="video/mp4">
            </video>

            <div class="fundo-transparent">
            </div>
            ...
            <div class="login-box">
                <div class="card ard-outline" style="border-top: 5px solid #889b73;border-right: 5px solid #889b73;">
                    ...
                    <div class="card-header text-center mb-4 py-4">
                        ...
                        <h3 class="" style="color: #889b73">MUTUE CASH</h3>
                    </div>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="col-12 mb-4">
                                <div class="input-group">
                                    <input type="text" v-model="form.email" :class="{'is-invalid' : form.errors.email}" class="form-control form-control-lg text-center" placeholder="Email" />
                            ...
                            <div class="col-12 mb-4">
                                <div class="input-group">
                                    <input type="password" v-model="form.password" :class="{'is-invalid' : form.errors.password}"  class="form-control form-control-lg text-center" placeholder="Password" />
                                    <div class="input-group-append">
                                        <div class="input-group-text">
